...
void CWaveletTransformDoc::OnWaveletEncode()
{
	...
	double* m_Conv1 = NULL; double* m_Conv2 = NULL; double* m_Conv3 = NULL; double* m_Conv4 = NULL;
	// Convolution을 위한 버퍼
	double* m_Down1 = NULL; double* m_Down2 = NULL; double* m_Down3 = NULL; double* m_Down4 = NULL;
	// 다운 샘플링을 위한 버퍼
	double* m_Hor = NULL; double* m_Ver1 = NULL; double* m_Ver2 = NULL;
	double** m_L = NULL; double** m_H = NULL; double** m_LL = NULL; double** m_LH = NULL; double** m_HL = NULL;
	double** m_HH = NULL; double** m_SLL = NULL; double** m_SLH = NULL; double** m_SHL = NULL; double** m_SHH = NULL;
...
void CWaveletTransformDoc::OnWaveletDecode()
{
	int i, j, k;
	int width, height;
	double *tempLL = NULL; double *tempLH = NULL; double *tempHL = NULL; double *tempHH = NULL; double *tempL = NULL; double *tempH = NULL;
	double **L = NULL; double **H = NULL;
	double *Up1 = NULL; double *Up2 = NULL; double *Up3 = NULL; double *Up4 = NULL;
	double *Conv1 = NULL; double *Conv2 = NULL; double *Conv3 = NULL; double *Conv4 = NULL;
	double **R = NULL;
